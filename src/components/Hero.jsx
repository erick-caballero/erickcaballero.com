...
export default function Hero({ scrollToSection }) {
    return (
        <section id="hero" className="min-h-screen md:h-screen flex flex-col justify-center relative overflow-hidden px-6 pb-24 md:pb-0 md:pl-32 md:pr-8">
            <div className="max-w-[1600px] w-full mx-auto z-10 h-full flex flex-col justify-center relative">
                ...
                >
                    <h1 className="text-7xl md:text-7xl lg:text-9xl font-bold text-white tracking-tighter md:tracking-tight leading-none mb-8">
                        Erick <br />
                ...
                <motion.div
                    className="mt-12 self-center md:absolute md:bottom-8 md:left-[168px] md:self-auto text-white/30 cursor-pointer"
                    onClick={() => scrollToSection(1)}
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
